      ...
      <div className="flex gap-3 flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
        <div className="flex w-full flex-col gap-3 sm:flex-1 sm:flex-row">
          <div className="relative flex-1">
            <span className="material-symbols-outlined absolute right-3.5 top-3.5 text-outline text-lg">search</span>
            <input 
              placeholder="ابحث بالاسم، الهاتف، كود الطالب، أو البريد الإلكتروني..." 
              value={search} 
              onChange={e => { setSearch(e.target.value); setPage(1); }}
              className="w-full pl-4 pr-10 py-3 bg-surface-container-low border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary rounded-lg text-xs text-on-surface placeholder:text-outline focus:outline-none transition" 
            />
          </div>
          <select 
            value={statusFilter} 
        ...
        {total > 20 && (
          <div className="flex items-center justify-between px-5 py-4 border-t border-outline-variant bg-surface-container-low select-none">
            <button 
              ...
              disabled={page <= 1}
              className="flex items-center gap-1.5 px-4 py-2 bg-white hover:bg-surface-container border border-outline-variant text-on-surface-variant rounded-lg disabled:opacity-30 disabled:cursor-not-allowed text-xs transition duration-300"
            >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-4 bg-surface-container-low border border-outline-variant rounded-xl space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-on-surface-variant mr-1">المبلغ (جنيه مصري ج.م)</label>
                          <input 
                            type="number"
                        ...
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-on-surface-variant mr-1">ربط بكورس (اختياري)</label>
                          <select 
                            value={txCourseId}
                        ...
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-on-surface-variant mr-1">ملاحظة المعاملة</label>
                          <input 
        ...
        >
          ...
          >
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold text-on-surface-variant mr-1">الدورة الدراسية</label>
              <select 
