        ...
        >
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-on-surface-variant">البريد الإلكتروني (يجب أن يتطابق مع بريده في Supabase)</label>
                <input 
                  required
                  type="email"
                  placeholder="assistant@chemistry.com" 
                  value={newEmail} 
