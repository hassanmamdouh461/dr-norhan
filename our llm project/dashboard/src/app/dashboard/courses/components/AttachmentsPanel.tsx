...
export default function AttachmentsPanel({ lessonId, isOpen, onClose }: AttachmentsPanelProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-6 max-w-xl w-full space-y-5 shadow-ambient zoom-in-95 duration-200 text-right"
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-xs border border-outline-variant rounded-xl focus:border-primary outline-none text-right"
              />
            </div>
