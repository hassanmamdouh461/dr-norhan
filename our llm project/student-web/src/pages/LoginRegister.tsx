...
import chemistryBg from '../assets/chemistry_bg.webp';
...
export const LoginRegister: React.FC<LoginRegisterProps> = ({ onBrowseAsGuest }) => {
  ...
  const themeBg = isDarkMode ? '#050507' : '#f8fafc';
  ...
  const secondaryText = isDarkMode ? '#94a3b8' : '#475569';
  const inputBorderDefault = isDarkMode ? 'rgba(255, 255, 255, 0.15)' : 'rgba(52, 211, 153, 0.2)';
  const inputBgColor = isDarkMode ? 'transparent' : '#ffffff';
  const inputTextColor = isDarkMode ? '#ffffff' : '#0f172a';
  ...
  useEffect(() => {
    document.title = 'تسجيل الدخول | كيميا';
    return () => {
    ...
    <div className="login-landing-container" style={{ 
      ...
      <style>{`
        ...
        .hero-display-title .em {
          background: linear-gradient(120deg, #34d399 0%, #34d399 45%, var(--lh-gold) 100%);
        ...
        .auth-tabs button.active {
          background: linear-gradient(135deg, #12c58c 0%, #0b9e70 100%);
          color: #fff;
        ...
        .exact-hero-link:hover { color: #34d399; }
      ...
      <section
        ...
        style={{
          ...
          background: isDarkMode
            ? 'radial-gradient(1100px 700px at 80% 15%, #123528 0%, transparent 55%), radial-gradient(900px 600px at 10% 90%, rgba(220, 187, 109, 0.06) 0%, transparent 55%), linear-gradient(180deg, #081109 0%, #050a07 100%)'
            : 'radial-gradient(1100px 700px at 80% 15%, #dff6ec 0%, transparent 55%), radial-gradient(900px 600px at 10% 90%, rgba(154, 123, 45, 0.08) 0%, transparent 55%), linear-gradient(180deg, #f6fbf8 0%, #e9f5ef 100%)',
          ...({
            '--lh-ink': isDarkMode ? '#f2f6f3' : '#0b1f17',
            '--lh-ink-soft': isDarkMode ? 'rgba(233, 242, 237, 0.65)' : 'rgba(11, 31, 23, 0.65)',
            '--lh-gold': isDarkMode ? '#dcbb6d' : '#9a7b2d',
            ...
            '--lh-input-bg-focus': isDarkMode ? 'rgba(5, 11, 8, 0.9)' : '#ffffff',
            ...
            '--lh-arch-top': isDarkMode ? '#0e3d2d' : '#bce8d6',
            '--lh-arch-bottom': isDarkMode ? '#07130e' : '#8fd4bb',
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            zIndex: 0,
            WebkitMaskImage: 'linear-gradient(to right, black 25%, transparent 90%)',
            maskImage: 'linear-gradient(to right, black 25%, transparent 90%)'
          }}
        />

        {/* Code-drawn floating calligraphy words (crisp + theme-aware) */}
        <div className="hero-floating-words" aria-hidden="true">
          <span className="fw fw-1">Fe₂O₃</span>
          <span className="fw fw-2">HNO₃</span>
          <span className="fw fw-3">NaOH</span>
          <span className="fw fw-4">NH₃</span>
          <span className="fw fw-5">H₂SO₄</span>
          <span className="fw fw-6">C₂H₅OH</span>
        </div>
        ...
        <div style={{
          ...
          width: '300px',
          height: '300px',
          background: `radial-gradient(circle, ${isDarkMode ? 'rgba(220, 187, 109, 0.10)' : 'rgba(154, 123, 45, 0.12)'} 0%, transparent 70%)`,
          borderRadius: '50%',
          filter: 'blur(70px)',
          pointerEvents: 'none',
          zIndex: 1
          ...
          <div className="login-hero-intro-column" style={{ display: 'flex', flexDirection: 'column', gap: '34px', textAlign: 'right' }}>
            ...
            <div className="exact-hero-title-container hero-reveal" style={{ animationDelay: '0.15s' }}>
              <h1 className="hero-display-title">
                ...
                <span className="em" style={{ display: 'block' }}>الكيمياء</span>
              </h1>
            ...
            <div className="exact-teacher-portrait-container hero-reveal" style={{ display: 'flex', justifyContent: 'flex-start', overflow: 'visible', animationDelay: '0.3s', paddingBottom: '22px' }}>
              <div className="teacher-arch-frame">
                <div className="teacher-arch-inner">
                  <img src={teacherPortrait} alt="معلم الكيمياء على منصة كيميا" />
                </div>
              ...
              {isForgotPassword ? (
                <form onSubmit={handleForgotPasswordSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  {forgotSent ? (
                    ...
                    <div>
                      <label className="exact-hero-label">البريد أو رقم الهاتف</label>
                ...
                <form onSubmit={handleSignUpSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  ...
                  <div>
                    ...
                    {fullName && !isFullNameValid(fullName) && (
                      <p style={{ color: isDarkMode ? '#f87171' : '#ef4444', fontSize: '11px', marginTop: '4px', textAlign: 'right', margin: 0 }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                    <div>
                      ...
                      >
                        {academicYears.map(g => <option key={g} value={g} style={{ color: '#000000', backgroundColor: '#ffffff' }}>{g}</option>)}
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={e => setSelectedSpec(e.target.value)}
                      >
                        {getSpecializations(selectedGrade).map(s => <option key={s} value={s} style={{ color: '#000000', backgroundColor: '#ffffff' }}>{s}</option>)}
                      </select>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                    <div>
                      ...
                      >
                        <option value="ذكر" style={{ color: '#000000', backgroundColor: '#ffffff' }}>ذكر</option>
                        <option value="أنثى" style={{ color: '#000000', backgroundColor: '#ffffff' }}>أنثى</option>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={e => setSelectedGov(e.target.value)}
                      >
                        {governorates.map(gov => <option key={gov} value={gov} style={{ color: '#000000', backgroundColor: '#ffffff' }}>{gov}</option>)}
                      </select>
                    </div>
                  </div>
                  ...
                  <div style={{ borderTop: '1px solid var(--lh-line)', paddingTop: '10px', display: 'flex', justifyContent: 'center' }}>
                    <span
                      ...
                      style={{ fontSize: '13px', color: '#34d399', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }}
                    >
      ...
      <section 
        ...
        style={{ 
          backgroundColor: isDarkMode ? '#0a0b0e' : '#ffffff',
            ...
            <div className="login-surround-card card-gold">
              ...
              <div className="login-surround-card-details">
                ...
                <p className="login-surround-card-desc" style={{ color: secondaryText }}>
                  شرح تفصيلي ومبسط يعتمد على بناء المفاهيم الكيميائية خطوة بخطوة بطرق مبتكرة تضمن الفهم الكامل.
                </p>
              </div>
            </div>
          ...
          <div className="login-teacher-center-column">
            ...
            <div className="login-teacher-portal-ring">
              <div className="login-teacher-portal-inner">
                <img src={teacherPortrait} alt="كيميا" />
              </div>
            </div>
          </div>
      ...
      <section 
        ...
        style={{ 
          backgroundColor: isDarkMode ? '#050507' : '#f8fafc'
        }}
      >
      ...
      {/* ── FOOTER Redesign ── */}
      <footer className="login-premium-footer" style={{ borderTop: `1px solid ${borderLight}`, backgroundColor: isDarkMode ? '#06070a' : '#f1f5f9' }}>
        <div className="login-section-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
          <span style={{ fontSize: '13.5px', color: secondaryText, fontWeight: '700' }}>
            ...
            <a 
              ...
              style={{ color: 'rgb(var(--primary))', textDecoration: 'none', fontWeight: 'bold' }}
            >
              سينابتك ستوديو
            </a>
          </span>
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center' }}>
            <a href="https://api.alhadaba-chemistry.synapticstudio.tech/files/apk" style={{ fontSize: '13.5px', color: 'rgb(var(--primary))', textDecoration: 'none', fontWeight: 'bold' }}>تحميل منصة الطالب (APK)</a>
            <span style={{ color: borderLight }}>|</span>
            <span style={{ fontSize: '13.5px', color: secondaryText }}>شريكك الأقوى للدرجة النهائية في الكيمياء</span>
          </div>
        </div>
      </footer>
      ...
      {showDeviceResetDialog && (
        <div className="modal-overlay">
          <div className="modal-content" style={{ padding: '24px', direction: 'rtl', backgroundColor: isDarkMode ? 'rgb(var(--surface-container-high))' : '#ffffff', border: cardBorder, color: themeText }}>
        ...
        <div className="modal-overlay" style={{ zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
          <div 
            ...
            style={{ 
              ...
              padding: '28px', 
              direction: 'rtl', 
              backgroundColor: isDarkMode ? 'rgb(var(--surface-container-high))' : '#ffffff', 
              border: cardBorder, 
              color: themeText,
