      ...
      <div className="flex flex-col">
        ...
        {profile ? (
          ...
          <div className="flex items-center" style={{ marginBottom: '40px', direction: 'rtl', justifyContent: isSidebarCollapsed ? 'center' : 'flex-start', gap: isSidebarCollapsed ? '0' : '12px' }}>
            ...
            {!isSidebarCollapsed && (
              <div>
                <h2 style={{ fontSize: '15px', fontWeight: 800, color: 'rgb(var(--on-surface))', letterSpacing: '0.5px', fontFamily: 'Cairo, sans-serif' }}>الهضبة</h2>
                <span style={{ fontSize: '11px', color: 'rgb(var(--on-surface-variant))', fontWeight: '600' }}>منصة الهضبة التعليمية</span>
              </div>
            )}
          </div>
        )}
