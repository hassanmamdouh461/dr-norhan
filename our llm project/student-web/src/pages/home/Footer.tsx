    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', maxWidth: '320px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <h3 style={{ fontSize: '15px', fontWeight: '900', color: 'rgb(var(--on-surface))', margin: 0, fontFamily: 'Cairo, sans-serif' }}>منصة كيميا التعليمية</h3>
        </div>
        <p style={{ fontSize: '11px', color: 'rgb(var(--on-surface-variant))', lineHeight: '1.6', margin: 0 }}>
          منصة كيميا من الهضبة لشرح مادة الكيمياء للثانوية العامة بأحدث الطرق التفاعلية والامتحانات الذكية.
        </p>
      </div>
