...
// Firebase Web app "SYNAP" (project synaptic-3ef0d). These values are
// safe to embed client-side — Firebase config is not a secret, access is
// enforced server-side by Firebase security rules / our own backend auth.
