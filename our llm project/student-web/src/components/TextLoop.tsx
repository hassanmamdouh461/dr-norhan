...
export const TextLoop: React.FC<TextLoopProps> = ({
  text = 'GRAVITY FOR PHYSICS ✦ فِيزْيَاءٌ مَفْهُومَةٌ.. مِشْ مَحْفُوظَة ✦ م. نُورَان الصَّنَادِيقِي ✦ تَعَلَّمْ الفِيزْيَاءَ بِشَغَفْ ✦ حُلُولُ كِتَابِ الاِمْتِحَانِ وَنْيُوتِنْ',
  shape = 'wave',
  path,
  speed = 38,
  direction = 'forward',
