...
// Generic chemistry-themed cover used on course cards that have no cover_image set.
...
const CourseCoverFallback: FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    height="100%"
    role="img"
    aria-label="صورة تعبيرية لمقرر كيمياء"
  >
    <defs>
    ...
    <g stroke="#34d399" strokeOpacity="0.3" strokeWidth="1.5">
    ...
    <g transform="translate(148, 60)">
      ...
      <circle cx="20" cy="70" r="2.2" fill="#d1fae5" fillOpacity="0.8" />
      <circle cx="32" cy="58" r="1.6" fill="#d1fae5" fillOpacity="0.7" />
      <circle cx="26" cy="76" r="1.4" fill="#d1fae5" fillOpacity="0.6" />
      <rect x="17" y="-6" width="20" height="7" rx="1.5" fill="none" stroke="#5eead4" strokeOpacity="0.55" strokeWidth="2" />
    </g>

    {/* Round-bottom flask, right */}
    <g transform="translate(238, 40)">
      <circle cx="24" cy="70" r="34" fill="rgba(255,255,255,0.04)" stroke="#5eead4" strokeOpacity="0.45" strokeWidth="2" />
      <path d="M14 0 H34 V38 Q34 42 24 42 Q14 42 14 38 Z" fill="rgba(255,255,255,0.04)" stroke="#5eead4" strokeOpacity="0.45" strokeWidth="2" />
      <path d="M-8 62 A34 34 0 0 0 56 62 A34 34 0 0 1 -8 62 Z" fill="url(#ccf-liquid)" opacity="0.9" />
      <circle cx="18" cy="74" r="2.4" fill="#d1fae5" fillOpacity="0.75" />
      <circle cx="32" cy="82" r="1.8" fill="#d1fae5" fillOpacity="0.65" />
      <rect x="11" y="-6" width="26" height="7" rx="1.5" fill="none" stroke="#5eead4" strokeOpacity="0.45" strokeWidth="2" />
    </g>
  </svg>
);
