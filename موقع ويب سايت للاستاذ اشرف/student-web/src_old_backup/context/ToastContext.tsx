        ...
        {toasts.map((toast) => (
          <div
            ...
            style={{
              ...
              background: toast.type === 'success'
                ? 'linear-gradient(135deg, rgb(var(--fusha-feedback-success)) 0%, rgb(var(--fusha-feedback-success)) 100%)'
                : toast.type === 'error'
                  ? 'linear-gradient(135deg, rgb(var(--fusha-feedback-error)) 0%, rgb(var(--fusha-feedback-error)) 100%)'
                  : toast.type === 'warning'
                    ? 'linear-gradient(135deg, rgb(var(--fusha-feedback-warning)) 0%, rgb(var(--fusha-feedback-warning)) 100%)'
                    : 'linear-gradient(135deg, rgb(var(--fusha-teal-700)) 0%, rgb(var(--fusha-feedback-info)) 100%)',
              border: `1px solid ${
          ...
          >
            ...
            <span
              ...
              style={{
                fontSize: '22px',
                color: toast.type === 'success' ? 'rgb(var(--fusha-teal-400))'
                  : toast.type === 'error' ? 'rgb(var(--fusha-gold-500))'
                  : toast.type === 'warning' ? 'rgb(var(--fusha-gold-500))'
                  : 'rgb(var(--fusha-sage-400))',
                flexShrink: 0,
              }}
            >
