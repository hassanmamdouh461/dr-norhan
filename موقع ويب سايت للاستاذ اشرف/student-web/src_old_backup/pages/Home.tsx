...
export const Home: FC<HomeProps> = ({ onSelectCourse, onShowAuth, onSelectLesson }) => {
  ...
  useEffect(() => {
    ...
    document.title = `${titles[activeTab] || 'الرئيسية'} | فُصْحَى`;
  }, [activeTab]);
  ...
  return (
    <div className="home-layout-container" style={{ direction: 'rtl', display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      {/* ── Main Content Area ── */}
      <main className="fusha-matrix-bg" style={{ flex: 1, backgroundColor: 'rgb(var(--background))', overflowY: 'auto', padding: 'var(--main-pad)', height: '100%' }}>
