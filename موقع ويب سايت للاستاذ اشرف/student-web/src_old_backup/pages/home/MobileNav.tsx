  ...
  return (
    <div className="mobile-header" style={{ display: 'none', marginBottom: '24px', justifyContent: 'space-between', alignItems: 'center', direction: 'rtl' }}>
      <div className="flex gap-sm items-center">
        ...
        >
          {theme === 'dark' ? (
            <span className="icon animate-sun-beam" style={{ color: 'rgb(var(--fusha-gold-500))', fontSize: '20px' }}>light_mode</span>
          ) : (
            <span className="icon animate-moon-swing" style={{ color: 'rgb(var(--fusha-gold-500))', fontSize: '20px' }}>dark_mode</span>
          )}
        </button>
        ...
        {profile && Boolean(profile.streak_count) && (
          ...
          >
            <span className="material-symbols-outlined" style={{ fontSize: '16px', color: 'rgb(var(--fusha-gold-500))' }}>local_fire_department</span>
      ...
      <div className="flex items-center gap-sm">
        <h2 style={{ fontSize: '15px', fontFamily: 'Cairo, sans-serif', fontWeight: 'bold', color: 'rgb(var(--on-surface))' }}>فُصْحَى</h2>
