...
│             fusha-ashraf-api.<your-subdomain>.workers.dev                            │
│                                                                            │
...
|---|---|---|
| Production | `fusha-dashboard.pages.dev` | `fusha-ashraf-api.<your-subdomain>.workers.dev` |
| Staging | `staging.fusha-dashboard.pages.dev` | `fusha-ashraf-api-staging.<your-subdomain>.workers.dev` |
